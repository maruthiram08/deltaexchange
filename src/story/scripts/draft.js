...
//  - Same terms as the one-pager, so nothing changes meaning. Only the framing moves: "they" instead of "he", and
//    shorter sentences that end on the impact.
//  - The last pain sentence is the key line, so it is the one that costs the user something.
...
export const REEL = {
  "reach-oi-builder": {
    pain: "User taps a BTC option and lands on the Option details page. They want to check OI data or build a strategy. None of it is accessible in one click.",
    feature: "Add **shortcuts** to Option Chain, Analytics & Strategy Builder in Option page",
    demo: captions("reach-oi-builder", [
      "User browses BTC options on Home.",
      "Taps a contract.",
  ...
  "add-contracts": {
    pain: "Building a custom strategy requires a user to switch from Option Chain to the builder, and back again to Option Chain, to add option contracts. Multiple page switches.",
  ...
  "see-max-loss": {
    pain: "User creates a multi-leg strategy. Their trading system allows a max loss of 1k, but the strategy exceeds the cap. They won't realise it until they reach the Analyse Payoff screen.",
  ...
  "review-payoff": {
    pain: "User creates a multi-leg strategy and reaches the Strategy Order Preview screen. It only shows a list of contracts. Max loss, max profit and payoff are hidden behind the Analyse Payoff screen.",
  ...
  "cheap-or-rich": {
    pain: "User wants to trade options. Option chain data shows numbers but not whether premiums look cheap or expensive. They have to figure it out on their own by analysing data.",
  ...
  "oi-support": {
    pain: "User wants to sell a strangle and needs OI support and resistance. They have to scan and compare every strike to identify the support and resistance strikes.",
  ...
  "limit-orders": {
    pain: "User identifies a BO trade opportunity and wants to place a Limit order on the retest. The Zip-Trade bar currently allows market orders only. For other order types, they have to switch to the Trade tab or use the hidden workflow from Charts.",
  ...
  "exit-part": {
    pain: "User already has a position and wants to exit partial qty at TP1. TradingView charts and the Zip-Trade action bar lack partial exit functionality with a limit order. As a result, they need to switch to the Positions tab or rely on a hidden workaround using TradingView Charts.",
    feature: "**Dynamic Zip-trade Action Bar** - surfaces add, exit CTAs when the user holds a position",
  ...
  "liquidation-upfront": {
    pain: "User is about to place an order, or maybe their first trade. They can't see the current leverage before execution. They can't see the liquidation price before execution.",
    punch: 2,
  ...
  "change-size": {
    pain: "User is about to place an order and wants to adjust the position size. They have to type it in every time.",
  ...
  "atm-straddle": {
    pain: "User is in the Straddles tab, trying to find the ATM straddle. They need to switch screens to check the index price. Also, because of the instrument naming choice, it is difficult to spot the ATM straddle.",
    punch: 2,
  ...
  "market-pulse": {
    pain: "User sees BTC move. They don't know what moved the market. New bets, forced closes or a squeeze?",
  ...
  "first-trade-check": {
    pain: "User is about to execute their first order with leverage. Nothing explains the risk of high leverage.",
    feature: "**Warn before first leveraged trade.**",
    demo: captions("first-trade-check", [
      "A first-time user taps Long at 100x.",
  ...
  "stop-loss": {
    pain: "User places their first order without a stop-loss. The underlying may move aggressively against their position, and they may lose their capital.",
    feature: "Nudge user to put **stop-loss** in the first few sessions",
    demo: captions("stop-loss", [
      "A first-time user taps Long.",
  ...
  "algo-templates": {
    pain: "User wants to build a 7:30 pm range breakout strategy. The current template library has limited basic setups. They can't build it themselves and are left in frustration.",
  ...
  "paper-test": {
    ...
    pain: "User builds an algo and takes it live with real money. They have never watched it run, so a wrong rule costs real capital.",
