...
import { IDEAS, IDEA_COUNT } from "../ideas";
...
const DEMO_COUNT = IDEAS.filter((idea) => idea.story?.demo).length;
    ...
    <div className="index-page">
      ...
      <header className="index-hero">
        ...
        <p className="index-page__subtitle">
          A product teardown of Delta Exchange India's options app. Each idea starts with a friction in the trader's
        ...
        <p className="index-hero__stat">
          {IDEA_COUNT} ideas, each mapped to a pain point. {DEMO_COUNT} come with a live prototype.
        </p>
